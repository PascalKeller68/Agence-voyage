                        ...
                        if ( ! empty( $trip_starting_dates ) && is_array( $trip_starting_dates ) ) :
                            foreach ( $months as $key => $month_name ) :
                                if( in_array( $month_name, array_values( $trip_starting_dates ) ) ) : 
                                    echo "<li><a href='" . esc_url( get_the_permalink() ) . "?month=" . esc_html( $key ) . "#wte-fixed-departure-dates'>" . esc_html( $month_name ) . "</a></li>";
                                else :
                                    echo "<li><a class='disabled' href='#'>" . esc_html( $month_name ) . "</a></li>";
                                endif;
                            endforeach;
                        else :
