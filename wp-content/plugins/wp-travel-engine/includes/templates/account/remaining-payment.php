	...
	<table class="wpte-lrf-tables">
		<tr>
			...
			<td>
				...
				<span class="lrf-td-desc"><?php echo wp_travel_engine_get_formated_price_with_currency_code_symbol( $booking_object->cart_info['total'] ); ?></span>
			</td>
			<td>
			...
			<td>
				...
				<span class="lrf-td-desc"><?php echo wp_travel_engine_get_formated_price_with_currency_code_symbol( $due ); ?></span>
			</td>
		</tr>
	</table>
